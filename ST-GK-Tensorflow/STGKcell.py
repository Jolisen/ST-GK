...
def load_assist_data(dataset,model_name):
    if model_name == 'tgcn':
        ...
        print("10")
        sz_adj = pd.read_excel('./ST-GKdata/%s_adj.xlsx'%dataset, header=None)
        adj = np.mat(sz_adj)
        data = pd.read_excel('./ST-GKdata/%s_feature_matrix_X.xlsx'%dataset)
    return data, adj
...
def preprocess_data(data1,  time_len, train_rate, seq_len, pre_len, model_name, scheme):
    ...
    if model_name == 'tgcn':
    ...
    elif model_name == 'ST-GK':################ST-GK###########################
        print("10")
        direction = pd.read_excel('./ST-GKdata/3611817550_direction.xlsx',header = None)
        ...
        beach_width = pd.read_excel('./ST-GKdata/3611817550_beach_width.xlsx',header = None)
        ...
        Reservoir_water_level = pd.read_excel('./ST-GKdata/3611817550_Reservoir_water_level.xlsx',header = None)
        ...
        phreatic_line = pd.read_excel('./ST-GKdata/3611817550_phreatic_line.xlsx',header = None)
        ...
        precipitation = pd.read_excel('./ST-GKdata/3611817550_precipitation.xlsx',header = None)
